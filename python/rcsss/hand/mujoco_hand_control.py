...
class MujocoHandControl(HandControl):
    ...
    """
    def __init__(self, xml_path: str, verbose=False):
        ...
        self.pos_vector_names_list = [
                                        ...
                                        "WRIST_PITCH", "WRIST_YAW" # wrist joints are only in tilburg hand and not used
    ...
    def grasp(self, value: float = 1.5):
        """
