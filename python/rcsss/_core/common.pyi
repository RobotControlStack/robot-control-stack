...
class NRobotsWithGripper:
    ...
    def get_joint_position(self, idxs: list[int]) -> list[numpy.ndarray[numpy.float64[7, 1]]]: ...
    ...
    def set_joint_position(self, idxs: list[int], q: list[numpy.ndarray[numpy.float64[7, 1]]]) -> None: ...
...
class Pose:
    ...
    @typing.overload
    def __init__(
        self, rotation: numpy.ndarray[numpy.float64[3, 3]], translation: numpy.ndarray[numpy.float64[3, 1]]
    ) -> None: ...
    @typing.overload
    def __init__(
        self, quaternion: numpy.ndarray[numpy.float64[4, 1]], translation: numpy.ndarray[numpy.float64[3, 1]]
    ) -> None: ...
    @typing.overload
    def __init__(self, rpy: RPY, translation: numpy.ndarray[numpy.float64[3, 1]]) -> None: ...
    ...
    def rotation_m(self) -> numpy.ndarray[numpy.float64[3, 3]]: ...
    def rotation_q(self) -> numpy.ndarray[numpy.float64[4, 1]]: ...
...
class Robot:
    ...
    def get_joint_position(self) -> numpy.ndarray[numpy.float64[7, 1]]: ...
    def get_parameters(self) -> RConfig: ...
    def get_state(self) -> RState: ...
    def move_home(self) -> None: ...
    def set_cartesian_position(self, pose: Pose) -> None: ...
    def set_joint_position(self, q: numpy.ndarray[numpy.float64[7, 1]]) -> None: ...
